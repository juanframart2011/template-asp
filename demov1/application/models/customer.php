...
{	
	...
	*/
	...
	function guardar_cliente($nombre,$apellidos,$telefono)
	{
		$data=array("first_name"=>$nombre,"last_name"=>$apellidos,"phone_number"=>$telefono);
		$this->db->insert("phppos_people",$data);
		$person_id=$this->db->insert_id();

		$this->db->insert("phppos_customers",array("person_id"=>$person_id));
