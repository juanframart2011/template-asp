...
<div id="content-header" class="hidden-print sales_header_container">
		<div class="row">
			<div class="col-md-4"><h1 class="headigs"> <i class="icon fa fa-barcode"></i>
				Buscar Cotización.<h3></h3>
			</div>
		</div>
		 	<span id="ajax-loader"><?php echo img(array('src' => base_url().'/img/ajax-loader.gif')); ?><br>
		</span>
		<div class="row">
			<div class="col-md-6">
				<label>Seleciona el cliente:</label>
...
$( "#txtcliente" ).autocomplete({
      ...
      select: function (event, ui) {
      		...
      		tabla.destroy();
			    ...
			    $('#tabla').DataTable({
			"ajax": {
				url:"<?php echo base_url().'index.php/cotizacion/get_cotizaciones'; ?>",
				type:"GET",
				dataType:"json",
				data:{customer_id:ui.item.value,tabla:1},
				async:false,
			...
			"columnDefs": [
		{
			"render": function ( data, type, row ) {
				return 	'<a href="/index.php/cotizacion/venta/'+row.id_cotizacion+'" <button class="btn btn-info">Cotizar o Vender.</button></a><a href="/index.php/cotizacion/venta/'+row.id_cotizacion+'" <button class="btn btn-danger">Eliminar</button></a>';
			},
			"targets": 4
