...
<?php
	if($data->email){
	    ...
	    $to = $data->email;
	    $subject = "Cotizacion.";
	    $message = $message.$logo.$datos.$prod.$footer;
	    $headers = 'MIME-Version: 1.0' . "\r\n";
	    $headers .= 'Content-type: text/html; charset=utf-8' . "\r\n";
	    mail($to,$subject,$message, $headers);
	    echo "<label><h4>Cotización # ".$data->id_cotizacion." Enviada con éxito al Email:".$data->email."</h4></label>";
	}else{
		 echo "<label><h4>No se pudo enviar la cotización.Captura el Email del Cliente.Clientes->Editar y capturar el Email.</h4></label>";
