...
<div class="col-md-12"><h1 class="text-center">Datos de facturacion</h1></div>
<div class="form-group">	
...
<div class="form-group">	
<label for="" class="col-sm-3 col-md-3 col-lg-2 control-label" >Rfc</label>
	<div class="col-sm-9 col-md-9 col-lg-10">
	<?php echo form_input(array(
		'class'=>'form-control form-inps',
		'name'=>'rfc',
...
<div class="form-group">	
<label for="" class="col-sm-3 col-md-3 col-lg-2 control-label" >Calle</label>
	<div class="col-sm-9 col-md-9 col-lg-10">
	<?php echo form_input(array(
		'class'=>'form-control form-inps',
		'name'=>'calle',
		'id'=>'calle',
		'value'=>$person_info->calle));?>
	</div>
</div>
<div class="form-group">	
<label for="" class="col-sm-3 col-md-3 col-lg-2 control-label" >Número interior</label>
	<div class="col-sm-9 col-md-9 col-lg-10">
	<?php echo form_input(array(
		'class'=>'form-control form-inps',
		'name'=>'num_interior',
		'id'=>'num_interior',
		'value'=>$person_info->num_interior));?>
	</div>
</div>
<div class="form-group">	
<label for="" class="col-sm-3 col-md-3 col-lg-2 control-label" >Número exterior</label>
	<div class="col-sm-9 col-md-9 col-lg-10">
	<?php echo form_input(array(
		'class'=>'form-control form-inps',
		'name'=>'num_exterior',
		'id'=>'num_exterior',
		'value'=>$person_info->num_exterior));?>
	</div>
</div>
<div class="form-group">	
<label for="" class="col-sm-3 col-md-3 col-lg-2 control-label" >Colonia</label>
	<div class="col-sm-9 col-md-9 col-lg-10">
	<?php echo form_input(array(
		'class'=>'form-control form-inps',
		'name'=>'colonia',
		'id'=>'colonia',
		'value'=>$person_info->colonia));?>
	</div>
</div>
<div class="form-group">	
<label for="" class="col-sm-3 col-md-3 col-lg-2 control-label" >Delegacion</label>
	<div class="col-sm-9 col-md-9 col-lg-10">
	<?php echo form_input(array(
		'class'=>'form-control form-inps',
		'name'=>'delegacion',
		'id'=>'delegacion',
		'value'=>$person_info->delegacion));?>
	</div>
</div>
<div class="form-group">	
<label for="" class="col-sm-3 col-md-3 col-lg-2 control-label" >localidad</label>
	<div class="col-sm-9 col-md-9 col-lg-10">
	<?php echo form_input(array(
		'class'=>'form-control form-inps',
		'name'=>'localidad',
		'id'=>'colonia',
		'value'=>$person_info->localidad));?>
	</div>
</div>
