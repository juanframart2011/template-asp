	...
	<body data-color="grey" class="flat">
		...
		<div id="user-nav" class="hidden-print hidden-xs">
			<ul class="btn-group ">
				...
				<li class="btn  ">
					<a href="/index.php/cotizacion">
						<i class="icon fa fa-thumb-tack"></i><span class="text">Cotizaciones</span>
					</a>
				</li>
				<li class="btn  ">
					<a href="/index.php/facturacion">
						<i class="icon fa fa-credit-card"></i><span class="text">Facturación</span>
					</a>
				</li>
		...
		<?php } ?>
				<li  <?php echo $this->uri->segment(1)=='home'  ? 'class="active"' : ''; ?>><a href="<?php echo site_url(); ?>"><i class="icon fa fa-coffee"></i><span class="hidden-minibar">Inicio</span></a></li>
