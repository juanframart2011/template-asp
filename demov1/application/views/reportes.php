...
<div class="text-center"> 
 <div class="table-responsive">
        <table id="register" class="table table-bordered">
          ...
          <thead>
            <tr>
              ...
              <th class="sales_item sales_items_number">Abono</th>
	...
	foreach ($pedidos->result() as $pedido){
	  ...
	  <tr>
    <td></td>
	  <td><a href="<?= base_url().'index.php/welcome/reportes/'.$pedido->sale_id ?>"><?= $pedido->cliente ?></a></td>
