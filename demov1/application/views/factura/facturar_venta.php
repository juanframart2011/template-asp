...
<div id="content-header" class="hidden-print">
	<h1 > <i class="fa fa-pencil"></i>  Facturar venta.	</h1>
</div>
<div id="breadcrumb" class="hidden-print">
	<?php echo create_breadcrumb(); ?> <a class="current" href="#">Buscar venta sin facturar.</a>
</div>
<div class="clear"></div>
...
<div class="row">
	<div class="col-md-6">
		...
		<div class="col-md-12 top">
			...
			<button id="buscar_facturas" type="submit" class="col-md-6 top btn btn-primary btn-MD">Buscar venta.</button>
		</div>
	</div>
</div>
...
$(function(){
	...
	$("#buscar_facturas").on('click',function(){ 
		...
		$.ajax({
			url:"index.php/factura/buscar_ventas_sin_factura",
			type:"GET",
   ...
   columnDefs: [ {
   			render: function ( data, type, row ) {
				return 	'<a href="<?php echo base_url(); ?>/index.php/factura/realizar_factura/'+row.sale_id+'/'+row.person_id+'"><button>Realizar factura</button></a>'
			},
